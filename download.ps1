...
$files = @(
    ...
    [PSCustomObject]@{ Name = "DIE x86 (ZIP)"; FileName = "die_win32_portable_3.21_x86.zip"; URL = "https://github.com/horsicq/DIE-engine/releases/download/3.09/die_win32_portable_3.09_x86.zip" }
    [PSCustomObject]@{ Name = "DIE x64 (ZIP)"; FileName = "die_win64_portable_3.21_x64.zip"; URL = "https://github.com/horsicq/DIE-engine/releases/download/3.09/die_win64_portable_3.09_x64.zip" }
